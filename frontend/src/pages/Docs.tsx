...
function App() {
  ...
  return (
      <div className="min-h-screen bg-background">
        {/* Main Header */}
        <header className="border-b border-border bg-gradient-to-r from-blue-50 to-indigo-50">
          <div className="container mx-auto px-4 py-6">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-3xl font-bold text-foreground">Document Verification & Campus Assistant</h1>
                <p className="text-muted-foreground mt-2">
                  Upload college documents to verify information and learn how to integrate Campus Assistant
                </p>
              </div>
        ...
        <section className="py-8 bg-white">
          <div className="container mx-auto px-4">
            <PdfUploadWidget universityId="univ_001" />
          </div>
        </section>
